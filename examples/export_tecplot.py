...
DEFAULT_MSH_FILE = os.path.join(BASE_DIR, "..", "gmsh_work", "example1.msh")
DEFAULT_CSV_DIR = os.path.join(BASE_DIR, "csv_data")
DEFAULT_OUT_DIR = os.path.join(BASE_DIR, "tecplot")
